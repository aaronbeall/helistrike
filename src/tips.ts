/** Loading-screen / mission tips shown to the player. */
export const LOAD_TIPS = [
  ...
  "Watch your laser sight — it shows where rounds will land, and clips on terrain before they do.",
  "Strafe (A/D) and rise or dive (SPACE/SHIFT) both throw off enemy aim — don’t sit still under fire.",
];
